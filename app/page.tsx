...
import { Wallet, Car, Bus, Train, ArrowRight, Shield, Globe, DiscIcon as Discord, Twitter } from "lucide-react"
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <a href="#features" className="text-sm font-medium hover:text-rally-coral">
              Features
            </a>
            <a href="#how-it-works" className="text-sm font-medium hover:text-rally-coral">
              How it Works
            </a>
            <Button className="font-gugi bg-gradient-to-r from-rally-pink to-rally-coral hover:opacity-90 text-white">
              Join the Waitlist
            </Button>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                {/*
                <Button size="lg" variant="outline" className="font-gugi">
                  Watch Demo
                </Button>
                */}
              </div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="#" className="text-sm text-gray-600 hover:text-rally-coral">
                Privacy Policy
              </a>
              <a href="#" className="text-sm text-gray-600 hover:text-rally-coral">
                Terms of Service
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-gray-600 hover:text-rally-coral"
              >
            ...
            <p className="text-sm text-gray-600">© {new Date().getFullYear()} RALLY. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
